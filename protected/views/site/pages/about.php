...
<p style="margin-top: 59px;font-size: 17px;text-align : justify;">
    <img style="width: 64px;margin-top:-15px"src="<?php echo Yii::app()->getBaseUrl(true);?>/images/ainegro.png"/> es una empresa  líder en el campo de la asesoría jurídica y tributaria. Contribuimos al desarrollo de nuestros clientes por medio de la prestación de servicios de alta calidad, brindando el soporte adecuado para que se encuentren a la vanguardia en el aprovechamiento de los recursos legales y en la prevención de los riesgos tributarios.
<br/><br/>
